      ...
      <div className="max-w-[1100px]">
        ...
        <div className="mt-16 mb-6">
          <div className="flex flex-col md:flex-row justify-between md:items-end gap-2 md:gap-0 mb-4">
            <h1 className="text-xl md:text-[35px] font-black text-[#003219]" style={{ lineHeight: '100%', letterSpacing: '-2px' }}>Settings</h1>
            <p className="text-sm md:text-[15px] font-normal italic text-[#003219]" style={{ lineHeight: '130%', letterSpacing: '0' }}>Manage admin access for your school</p>
          </div>
          {/* Divider */}
